        ...
        <section className="Contact">
            <div className="container">
                <div className="Contact__image">
                    <img className="GlassEffect" src={ProfileIMG} alt="Profile"/>
                </div>
                ...
                <div className="Contact__profile">
                    ...
                    <div className="Contact__profile_actions">
                        <button className="GlassEffect" onClick={() => emailMe()}>
                            <EmailIcon/>
                        </button>
                        <button className="GlassEffect" onClick={() => callMe()}>
                            <PhoneIcon/>
                        </button>
                    ...
                    <div className="Contact__profile_contact GlassEffect infoBlock ">
                        <label className="Contact__profile_notes-label">
                            <img src={ProfileIMG}/>
                            <span className="Contact__profile_notes-name">Contact Photo & Poster</span>
                        </label>

                    </div>


                    <div className="Contact__profile_notes GlassEffect infoBlock ">
                        <label className="Contact__profile_notes-label">
                    ...
                    <div className="Contact__profile_share infoBlock GlassEffect">
                        <a
                            onClick={() => emailMe()}
                            className="Contact__profile_notes-label"
                        >
